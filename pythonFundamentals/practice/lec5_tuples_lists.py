...
#
#
# (quot, rem) = quotient_and_remainder(12, 6)
# print(quot)
# print(rem)
...
s = ["pranjal", "is", "my", "name"]
stringharu = " ".join(s)
print(stringharu)  # Output: pranjal is my name

# Create a new string with the replaced value
replaced_string = stringharu.replace("p", "b")

# Print the replaced string
print(replaced_string)  # Output: branjal is my name
